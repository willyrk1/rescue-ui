...
const VolunteerForm = () => {
  const [backgroundConsent, setBackgroundConsent] = useState()
          ...
          <StandardForm.Input>
            <label htmlFor="background-check-yes">
              <input
                ...
                onChange={() => setBackgroundConsent(true)}
                value="true"
                required
              />
              Yes
              ...
              <Popup
                ...
                trigger={
                  <input
                    ...
                    onChange={() => setBackgroundConsent(false)}
                    value="false"
                  />
                }
              >
                      ...
                      <Popup
                        ...
                        trigger={
                          <input
                            ...
                            id="commit-no"
                            name="volunteer[commit_to_4_months]"
                            checked={timeCommit === false}
                            onChange={() => setTimeCommit(false)}
                            value="false"
                          />
                        }
                      >
