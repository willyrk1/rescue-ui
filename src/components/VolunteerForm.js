    ...
    <StandardLayout>
      <div className={cx('volunteer-form')}>
        ...
        >
          ...
          <p>
            There are several ways you can benefit St Francis as a volunteer. We
            desperately need foster homes for our animals and help at our
          ...
          <h2>Fostering</h2>
          <p>
            All our animals go into a foster home before they are adopted. This
            allows us to get a feel for their personality and temperament so we
            can match them properly with potential adopters. St Francis provides
            all veterinary care that is needed to get the animal ready for
            adoption (spay/neuter, vaccinations, worming, etc). It is the
            responsibility of the foster to bring their foster animal(s) to our
            vet for services and ultimately to our adoption center when they are
            ready for adoption. We advertise all animals ready for adoption on
            our website so we may we get an online adoption request for an
            animal in foster care. In that case the foster can either arrange to
            have the potential adopter visit the animal in their home or arrange
            to meet them with the animal at an adoption center.
          </p>
              ...
              {fosterCats && (
                <>
                  <p className={cx('fosterNote')}>
                    <strong>CATS:</strong> Our cats stay in foster care until a
                    cage is available at an adoption center. Once they go into a
                    cage at the adoption center, they remain there for a week or
                    so and then they go back to the foster home for a short cage
                    break before coming back to the adoption center.
                  </p>
                  <ul>
                    <li>
              ...
              {fosterDogs && (
                <>
                  <p className={cx('fosterNote')}>
                    ...
                    requested. Occasionally we have special adoption events and
                    request the foster bring their dog for viewing if possible.
                  </p>
                  <ul>
                    <li>
                      <label htmlFor="dog-show">
                        Are you willing to take your foster dog to adoption
                        events?
                      </label>
                      <StandardForm.Input>
          ...
          <p>
            ...
            their cage for excercise, playtime and love. During that time their
            cage is cleaned and fresh water and food (if needed) is provided.
            Petsmart kennels for us in the morning, we kennel in the evening.
            For example, some volunteers pick a certain day of the week or maybe
            every other particular weekday. Some volunteers fill in where there
            are gaps in the schedule for the month. We try to make it flexible
            for the volunteers.
          </p>
          ...
          <p>
            <strong>Dog Handler:</strong> Dog handlers assist fosters by showing
            dogs at adoption events and talking to potential adopters about the
            dog's personality and likes/dislikes.
          </p>

          <ul>
            <li>
              <label htmlFor="dog-handler">
