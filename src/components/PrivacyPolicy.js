...
const PrivacyPolicy = () => (
  <StandardLayout>
    <div className={cx('privacy-policy')}>
      <h1>Privacy Policy of St. Francis Society, Inc.</h1>

      <p>
        St. Francis Society, Inc. operates the stfrancisrescue.org website,
      ...
      <p>
        ...
        decided to use our Service, the StFrancisRescue.org website.
      </p>
      ...
      <p>
        ...
        Terms and Conditions, which is accessible at stfrancisrescue.org, unless
      ...
      <p>
        ...
        not hesitate to <Link to="/contact">contact us</Link>.
      </p>
    </div>
  </StandardLayout>
)
