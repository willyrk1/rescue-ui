...
const Footer = ({ legal }) => (
  <div className={cx('footer')}>
    ...
    <div className={cx('bottom')}>
      {legal && (
        <p>
          ST. FRANCIS SOCIETY, INC. IS A PRIVATE- NON-PROFIT 501(c)(3) COPRORATION
          REGISTERED WITH THE FLORIDA DEPARTMENT OF AGRICULTURE & CONSUMER SERVICES.
          REGISTRATION NUMBER CH9650. A COPY OF THE OFFICIAL REGISTRATION AND FINANCIAL
          INFORMATION MAY BE OBTAINED FROM THE DIVISION OF CONSUMER SERVICES BY CALLING
          TOLL-FREE 800-435-7352 WITHIN THE STATE. REFER TO CH9650. REGISTRATION DOES
