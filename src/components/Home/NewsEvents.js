  ...
  <div className={cx('home-news-events')}>
    ...
    <div className={cx('panels')}>
      <div className={cx('panel')}>
        ...
        <h2>&nbsp;</h2>
        <p>
          Attorney Ken Afienko is a long time supporter and St. Francis adoptive
          pet parent. For a donation to St. Francis Society, he will provide a
        ...
        >
          {close => (
            <PopupModal close={close}>
              ...
              <PopupModal.Content>
                <p>
                  Attorney Ken Afienko is a long time supporter and St Francis
                  adoptive pet parent. He also proudly serves as a part-time
                  Pinellas County Police Officer. Ken is extending his
                  generosity to us with a unique offer. He will provide wills
                  and living wills for supporters who donate to St Francis
                  Rescue. 100% of the donation benefits our medical fund to help
                  sick and injured pets find new forever homes!
                </p>
              </PopupModal.Content>
              <PopupModal.Actions>
      ...
      <div className={cx('panel')}>
        ...
        <p>
          ...
          venenatis, mi id imperdiet rutrum, urna ante faucibus ex.
        </p>
    ...
    <div>
      <a className={cx('btn', 'btn--secondary')} href="#">
        View All
      </a>
    </div>
  </div>
