...
const ForeverFoster = () =>
  <StandardLayout>
    <div className={cx('forever-foster')}>
      ...
      <hr/>
      <p>
        A Forever Foster is a cat or dog that is unadoptable due to a medical or behavioral
        issue.  St. Francis Society will never euthanize an animal unless there is
        no further medical treatment that can done, or their behavior has become too aggressive
        for us to safely handle them.  We continue to care for the animals we have rescued as long
        as they need us.
      </p>
      <p>
        When you sponsor a Forever Foster, you not only help us vet and cure sick pets and get
        them adopted into loving homes, you also help us care for all the Forever Fosters that we
        continue to care for and love.
      </p>
      <p>
        ...
        {[{
          ...
          <div className={cx('animal-card')}>
            <div className={cx('pet-card')}>
              ...
              <a href='#' className={cx('btn')}>Sponsor</a>
            </div>
          </div>
        )}
      </div>
