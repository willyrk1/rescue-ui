...
const Donate = () =>
  <StandardLayout>
    <div className={cx('donate')}>
      ...
      <p>
        Click the "Donate" button and enter the amount you would like to donate. Please be sure
        the amount you enter reflects your intent. For instance, we've experienced donations
      ...
      <p>
        ...
        animals in our care with essentials such as food, medicine, litter, and spay/neuter surgeries.
      </p>
      ...
      <p>
        St. Francis Society Animal Rescue<br/>
        PO Box 261614<br/>
        Tampa, Fl 33685-1614
      </p>
